                ...
                <div class="col-md-12 blog-holder">
                    <div class="row">
                        ...
                        <div class="col-md-4 blog-item-wrapper">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="single.html"><img src="template/img/blog-1.jpg" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
                        ...
                        <div class="col-md-4 blog-item-wrapper">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="#"><img src="template/img/blog-2.jpg" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
                        ...
                        <div class="col-md-4 blog-item-wrapper">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="#"><img src="template/img/blog-3.jpg" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
                    ...
                    <div class="grid-portfolio">
                        ...
                        <div class="grid-item minimalism">
                            <div class="grid-item-wrapper">
                                <img src="template/img/photo-1.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                        ...
                        <div class="grid-item vintage">
                            <div class="grid-item-wrapper">
                                <img src="template/img/photo-6.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                        ...
                        <div class="grid-item creative grid-item-height">
                            <div class="grid-item-wrapper">
                                <img src="template/img/photo-2.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                        ...
                        <div class="grid-item creative">
                            <div class="grid-item-wrapper">
                                <img src="template/img/photo-7.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                        ...
                        <!-- <div class="grid-item minimalism">
                            <div class="grid-item-wrapper">
                                <img src="template/img/photo-3.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                        ...
                        <div class="grid-item vintage">
                            <div class="grid-item-wrapper">
                                <img src="template/img/photo-4.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                        ...
                        <div class="grid-item creative">
                            <div class="grid-item-wrapper">
                                <img src="template/img/photo-9.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
